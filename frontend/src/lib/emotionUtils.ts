...
export const therapyTechniques: TherapyTechnique[] = [
  ...
  },
  {
    ...
    description: 'Focusing on things you\'re thankful for to improve mood and perspective',
    forEmotions: ['sad', 'angry', 'disgust'],
    steps: [
      'Take a moment to reflect on your day',
      'Identify three things you\'re grateful for, no matter how small',
      'For each item, consider why you\'re grateful for it',
  ...
  },
  {
    ...
    steps: [
      ...
      'Focus on what you\'ve learned or how you\'ve grown from the experience'
    ]
  }
];
...
export const formatEmotionData = (emotions: Record<string, number>) => {
  return Object.entries(emotions).map(([emotion, value]) => {
    ...
    return {
      ...
      color: emotionColors[normalizedEmotion as keyof typeof emotionColors] || emotionColors.neutral
    };
  });
};
